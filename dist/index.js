...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, fetch_github_release_1.downloadRelease)('BrettMayson', 'HEMTT', 'hemtt', (release) => {
            ...
            return (isWin) ? asset.name === 'windows-x64.zip' : asset.name === 'linux-x64.zip';
        }, false, false);
        core.addPath('hemtt');
    });
}
...
const getReleases_1 = __nccwpck_require__(7653);
const getLatest_1 = __nccwpck_require__(882);
const download_1 = __nccwpck_require__(8226);
const rpad_1 = __nccwpck_require__(9636);
function pass() {
    return true;
}
const MultiProgress = __nccwpck_require__(4034);
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.downloadRelease = void 0;
const downloadRelease_1 = __nccwpck_require__(7800);
...
const Progress = __nccwpck_require__(892);
